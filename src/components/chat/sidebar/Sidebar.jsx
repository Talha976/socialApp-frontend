...
//   }
//   return (
//     <div className="bg-white bg-opacity-10 backdrop-blur-md shadow-lg border border-white border-opacity-20 rounded-lg p-6 h-[470px] w-[300px] mt-12 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-gray-600">
...
//           placeholder="Search"
//           className="bg-white bg-opacity-30 rounded-full text-white placeholder-white py-2 px-4 outline-none"
//         />
//         <button className="bg-white bg-opacity-30 text-white p-2 rounded-full cursor-pointer">
//           <FontAwesomeIcon
//             icon={faSearch}
//           />
//         </button>
...
//             <div
//               key={user._id}
//               className={`flex items-center gap-3 border-b p-2 cursor-pointer border-gray-600 pb-2 hover:bg-white hover:bg-opacity-30 hover:shadow-lg rounded-md
...
//                 alt={user.firstName}
//                 className='rounded-full h-13 w-13 bg-center '
//                 style={{ width: '60px', height: '60px' }} 
//               />
//             {isOnlineUser && (<div className={`absolute h-2 w-2 bg-green-600 rounded-full top-0 right-0`}></div>)}
//               </div>
//               <h6 className="text-white">{user.firstName}</h6>
//             </div>
//           );
//         })}
//       </div>
...
const Sidebar = ({ onChatClick }) => {
  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-blur-md shadow-lg border border-white border-opacity-20 rounded-lg p-6 h-[470px] w-[300px] mt-12 overflow-y-auto scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-gray-600 transition-all duration-200 ease-in-out">
      <form className="flex items-center justify-center gap-3 mb-4" onSubmit={handleSubmit}>
        <input
          type="text"
          value={search}
